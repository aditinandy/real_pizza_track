...
var cardCounter = document.querySelector('#cardCounter');
...
function updateCart(pizza) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', pizza).then(function (res) {
    ...
    new (noty__WEBPACK_IMPORTED_MODULE_1___default())({
      ...
      layout: 'top-left' // progressBar: false
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    ...
    var pizza = JSON.parse(btn.dataset.pizza); // convert in object
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpizza_realtime_tacker"] = self["webpackChunkpizza_realtime_tacker"] || [];
